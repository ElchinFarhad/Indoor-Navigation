...
export function shortestPathF(sourceID: number, destinationID: number) {
    ...
    //   setShortestPathArr(shortestPathArray);
    //   finalPath = shortestPathArray
    //   setShortestPathArr(prevVal => ([...prevVal, ...shortestPathArray]));

    //   console.log(finalPath, " RES HERE")
    }
    ...
    console.log(res, " This is Sparta")
